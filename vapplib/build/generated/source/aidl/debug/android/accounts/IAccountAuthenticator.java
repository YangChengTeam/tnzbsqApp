 ...
 * Original file: E:\\zdh\\as_workspace\\Tnzbsq2\\vapplib\\src\\main\\aidl\\android\\accounts\\IAccountAuthenticator.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_getAccountCredentialsForCloning, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_addAccountFromCredentials, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
