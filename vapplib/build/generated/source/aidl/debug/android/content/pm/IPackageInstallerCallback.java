 ...
 * Original file: E:\\zdh\\as_workspace\\Tnzbsq2\\vapplib\\src\\main\\aidl\\android\\content\\pm\\IPackageInstallerCallback.aidl
 */
...
mRemote.transact(Stub.TRANSACTION_onSessionCreated, _data, _reply, 0);
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(sessionId);
mRemote.transact(Stub.TRANSACTION_onSessionBadgingChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_onSessionActiveChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_onSessionProgressChanged, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
mRemote.transact(Stub.TRANSACTION_onSessionFinished, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
